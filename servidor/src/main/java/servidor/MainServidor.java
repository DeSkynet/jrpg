	...
	public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            if (socket != null) //pregunta esto por si el servidor esta lleno.
            	 new HiloServidor(socket, servidor.getJugadoresEnMapa(),servidor.getJugadoresConectados(),servidor.getJugadores(), daoJugador, daoPersonaje).start(); //Crea el hilo por cada conexion y lo pone a andar
            else{
